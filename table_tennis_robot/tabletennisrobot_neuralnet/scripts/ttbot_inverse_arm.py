...
load_slide_actor_path = "/home/lab606a/ros_workspace/catkin_ws/src/ttbot_tests/models/four_input_actor/0512v3-actor-slide-rand-256.h5"
load_slide_critic_path= "/home/lab606a/ros_workspace/catkin_ws/src/ttbot_tests/models/four_input_actor/0512v3-critic-slide-rand-256.h5"
load_slide_dis_path   = "/home/lab606a/ros_workspace/catkin_ws/src/ttbot_tests/models/four_input_actor/0512v3-discri-slide-rand-256.h5"
...
class Get_state():
    def __init__(self):
        ...
        rospy.Subscriber("/visual_coordinate", Float32MultiArray, self.ballxyz_callback)
    ...
    def ballxyz_callback(self, msg):
        self.state[0] = msg.data[1]/100 -0.762 #ball_x
        self.state[1] = msg.data[2]/100 -1.37 #ball_y
        self.state[2] = msg.data[3]/100 +0.76 +0.09 #ball_z
        '''
        if (msg.data[3]==-10.0):
            ...
            self.state[4] = msg.data[5]/100 +0.76 #hit_ball_z
        '''

        
    def realTTbot_state_callback(self, msg):
        self.state[5] = msg.position[0] #slide_pos
...
if __name__ == '__main__':
    rospy.init_node('ttbot_inverse_arm',anonymous=True)
    ...
    while not rospy.is_shutdown():
        ...
        if (TTbot_env.state[0]>0.3 and TTbot_env.state[0]<0.6) and (not get_init_state):
            get_init_state = True
            TTbot_step.save_joint_state(True)
        if loop_count > 300 and get_init_state:
            get_init_state = False
        ...
        if get_init_state:
            ...
            strike_point_x = TTbot_env.state[0]
            strike_point_y = TTbot_env.state[1]
            strike_point_z = TTbot_env.state[2]
            ...
            #action[0,1] = j1_action[0,0] * 2.36
            #action[0,1] = np.clip(action[0,1], -2.36, 2.36)
            print('1:{} 2:{} 3:{}'.format(abs(action[0,0] - strike_point_x), strike_point_x, strike_point_z))
